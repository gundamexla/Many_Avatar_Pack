...
Shader ".poiyomi/Master/Opaque"
{
    Properties
    {
        ...
        [Toggle(_FAKE_LIGHTING)]_FAKE_LIGHTING ("Enable Fake Lighting", Float) = 0
        [NoScaleOffset]_LightingGradient ("Lighting Ramp", 2D) = "white" { }
        _LightingNormalMultiplyer ("Normal Multiplyer", Float) = 1
        ...
        _SpecularNormalMultiplyer ("Normal Multiplyer", Float) = 1
        
        [Space][Header(Rim Glow)]
        ...
        [Space]
        _RimGlowNormalMultiplyer ("Normal Multiplyer", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _SpecularNormalMultiplyer;
            ...
            float _LightingNormalMultiplyer;
            ...
            float _RimGlowNormalMultiplyer;
            float _RimTexTile;
            float4 _RimColor;
            ...
            fixed4 frag(v2f i, float facing: VFACE): SV_Target
            {
                ...
                clip(col.a - _Clip);
                    ...
                    float3 rimColor = lerp(col.rgb, tex2D(_RimTex, i.uv * _RimTexTile + (_Time.y * _RimTexPanSpeed.xy)) * _RimColor, _RimColorBias) * _RimGlowStrength;
                    float3 cameraVertDot = abs(dot(i.cameraToVert, normalDirection * _RimGlowNormalMultiplyer));
                #endif
                    ...
                    float FakeLight = (dot(normalDirection * _LightingNormalMultiplyer, normalize(_LightDirection)) + 1) / 2;
                    ...
                    float4 specular = 0;
                        ...
                        float3 reflectionVector = reflect(i.cameraToVert, normalDirection * _SpecularNormalMultiplyer);
